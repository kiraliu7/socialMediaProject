...
if (!process.env.CLOUDINARY_URL) {
	process.env.CLOUDINARY_URL="cloudinary://271812864912292:qdl4Aimv4eC2WiwvOqueYR9CSgo@hzwltjyu9";
}

if (!process.env.CLOUD_NAME) {
	process.env.CLOUDINARY_NAME="hzwltjyu9";
}

if (!process.env.CLOUD_KEY) {
	process.env.CLOUDINARY_KEY="271812864912292";
}

if (!process.env.CLOUD_SECRET) {
	process.env.CLOUDINARY_SECRET="qdl4Aimv4eC2WiwvOqueYR9CSgo";
}

cloudinary.config({ 
	cloud_name: "hzwltjyu9",
	api_key: "271812864912292",
	api_secret: "qdl4Aimv4eC2WiwvOqueYR9CSgo"
  });
